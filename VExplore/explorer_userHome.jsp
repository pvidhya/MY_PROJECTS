	...
	%>
		<div id="container">
			<nav>
				<div>
					<ul>
						<li class="start selected"><a href="explorer_profile.jsp"><h4 style="color: white;" ><%=user.fname+" "+user.lname%></h4></a></li>
			...
			<nav>
				<div style="position:fixed;left:0px">
					<ul>
						...
						<li><a href="CreateItenirary.html">Create Trips</a></li>
						<!--<li><a href="#" onclick="changeview('trips.jsp')">Create Trips</a></li>-->
