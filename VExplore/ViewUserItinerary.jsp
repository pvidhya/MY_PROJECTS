...
<html>
	<head>
		...
		<style>
			div.showity { width:500px; background-color:#666;}
			...
			ul li a { display:block; width:300px; height:28px; background-color:#333; border-left:5px solid #222; border-right:5px solid #222; 
					  padding-left:10px;text-decoration:none; color:#bfe1f1; }
	...
	<script>
		...
		function sendrequest(itinry_id){
			var url = "http://localhost/Explorer/ViewFriendIti.jsp?itineraryid="+itinry_id;
			var wnd = window.open(url,"Message Sent","width=400,height=500");
		}
	...
	<body>
		<div style="position:fixed;width:500px">
			...
			<% 
				...
				List<Itinerary> usr_its = MySQLDataStoreUtilities.getInstance().getUserItineraries(id);
					...
					<div class="showity">
						<table>
							...
							<tr>
								...
								<td><a href="#" onclick="sendrequest(<%=it.id%>)"> View Friends </a></td>
							</tr>
						</table>
					</div>
				</li>
