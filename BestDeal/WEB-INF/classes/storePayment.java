...
public class storePayment extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// public void storePayment(String userName,int orderId,String orderName,double orderPrice,String userAddress,String creditCardNo){
	    ...
	    int orderName = Integer.parseInt(request.getParameter("orderId"));
		...
		OrderPayment orderpayment = new OrderPayment (orderName, userName, orderPrice, userAddress, creditCardNo, orderId, productName);
		listOrderPayment.add(orderpayment);
		try
		{
		MySqlDataStoreUtilities.insertOrder(orderName, userName, orderPrice, userAddress, creditCardNo, orderId, productName);
...
out.println("</script");
       ...
       // out.println("             <li> <h2> + user_type+ </h2>");
        ...
        out.println("");
        out.println("     <article>");
        out.println("<form action=\"storePayment\" method=\"post\">  ");
        out.println("<h1>Your order has been successfully placed!</h1>" );
        out.println("<h1>Your order id is : " + orderId +"</h1>");
        out.println("<h1>Estimated delivery date is: <p id='demo'></p></h1>");

out.println("<script>");
out.println("var d = new Date(2016,11,13);");
out.println("document.getElementById('demo').innerHTML = d;");
out.println("</script>");


            out.print("<input type='hidden' name='userName' value="+userName+" readonly>");
            out.print("<input type='hidden' name='orderId' value="+orderId+" readonly>");
            out.print("<input type='hidden' name='orderName' value="+orderId+" readonly>");
            out.print("<input type='hidden' name='productName' value="+productName+" readonly>");
            out.print("<input type='hidden' name='userAddress' value="+userAddress+" readonly>");
            out.print("<input type='hidden' name='orderPrice' value="+orderPrice+" readonly>");
            out.print("<input type='hidden' name='creditCardNo' value="+creditCardNo+" readonly>");
            // out.print("<input type = 'submit' class='button' name ='Continue Shopping' value = 'Submit'>");
            
            out.println("<a href=\"ServletProduct\"  class=\"start selected\"></a>");out.println("</form?");
