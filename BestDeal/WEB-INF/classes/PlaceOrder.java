...
public class PlaceOrder extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
           ...
           // long orderId = (long)(math.random()*2);
            // int orderId = Math.random();             
...
out.println("</script");
       ...
       // out.println("             <li> <h2> + user_type+ </h2>");
        ...
        out.println("<table>");
            out.print("<tr>Order Total: <input type=\"text\" name='orderPrice' value= "+orderPrice+" readonly></tr><br/><br/> ");
            out.println("<tr>Name:    <input type=\"text\" name=\"userName\"/></tr><br/> <br/>  ");
            out.println(" <tr><input type=\"hidden\" name=\"name\" value= "+productName+"/></tr><br/> <br/>  ");
            out.println("<tr>Address:    <input type=\"text\" name=\"userAddress\"/></tr><br/> <br/>  ");
            out.println("<tr>CreditCard number:  <input type=\"text\" name=\"creditCardNo\"/></tr><br/><br/>  ");
            out.println("</table>");
            //out.println("<h2>OrderName: " +userName+ "</h2>");
            ...
            //out.print("<input type='hidden' name='orderName' value="+userID+" readonly>");
            ...
            out.print("<input type = 'submit' class='button' name ='Checkout' value = 'Checkout'>");
            out.println("</form>");
