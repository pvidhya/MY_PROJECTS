    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                out.println("<tr><td>"+i+ "</td><td>"+pname+ "</td><td>"+price+ "</td>");
                ...
                out.print("<input type='hidden' name='name' value="+pname+" readonly>");
                out.print("<input type='hidden' name='orderPrice' value="+price+" readonly>");
