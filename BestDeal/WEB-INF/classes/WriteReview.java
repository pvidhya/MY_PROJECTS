...
out.println("</script");
       ...
       // out.println("             <li> <h2> + user_type+ </h2>");
        ...
        out.println("</br>" );
            ...
            out.println("<table border='1px'>");
            out.println("   ");
            out.print("<tr>ProductModelName: <input type=\"text\" name='name' value="+name+" readonly></tr><br/>");
            out.print("<tr>ProductPrice: <input type=\"text\" name='price' value= "+price+" readonly></tr><br/>");
