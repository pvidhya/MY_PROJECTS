...
public class PlaceOrder extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            // HttpSession session = request.setSession(true);
...
out.println("</script");
       ...
       // out.println("             <li> <h2> + user_type+ </h2>");
        ...
        out.println("<form action=\"storePayment\" method=\"post\">  ");
            // out.println("<h2>Product Placed successfully!</h2>");
            // out.println("<h2>OrderName: " +userName+ "</h2>");
            // out.println("<h2>OrderId: " +orderId+ "</h2>");
            out.print("<input type='hidden' name='userName' value="+userAddress+" readonly>");
            out.print("<input type='hidden' name='orderId' value="+orderId+" readonly>");
            out.print("<input type='hidden' name='orderName' value="+userName+" readonly>");
