...
public class Login1 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            PreparedStatement pst = conn.prepareStatement("Select * from registeruser where USERNAME=? and PASS=?");
            pst.setString(1, n);
            pst.setString(2, p);
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                if (rs.getString("usertype").equals("Storemanager")){
...
else if (rs.getString("usertype").equals("Salesmen")){
        out.println("<!doctype html>");
        out.println("<html>");
        out.println("<head>");
        out.println("<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" />");
        ...
        out.println(" <li><form method= 'post' action= 'Update_Orders'>");
        out.println("<input type= 'hidden' name= 'userName' value= "+n+">" );
        out.println("<input type= 'submit' name= 'orders' value= 'Update Cart' style= 'height: 65px;'></form></li>");
        // out.println("             <li class= \"nav_bar_cart\">");
        // out.println("             <a href= \"Cart_Orders\"><img src= \"images/cart.png\" style=\"width: 20px; height: 13px\">");
        // out.println("                </a>");
        out.println("            </li>");
        out.println("        </ul>");
        out.println("    </nav>");
        // out.println(" <form method= 'post' action= 'Update_Orders'>");
        // out.println("<input type= 'hidden' name= 'userName' value= "+n+">" );
        // out.println("<input type= 'submit' name= 'orders' value= 'Update Orders'>");
}
else {
        out.println("<!doctype html>");
        out.println("<html>");
        ...
        out.println("<input type= 'hidden' name= 'userName' value= "+n+">" );
        out.println("<input type= 'submit' name= 'orders' value= 'My Cart' style= 'height: 65px;'></form></li>");
       

        out.println("            </li>");
        out.println("        </ul>");
        out.println("    </nav>");
        out.println(" <form method= 'post' action= 'Cart_Orders'>");
        out.println("<input type= 'hidden' name= 'userName' value= "+n+">" );
        out.println("<input type= 'submit' name= 'orders' value= 'Orders'>");
